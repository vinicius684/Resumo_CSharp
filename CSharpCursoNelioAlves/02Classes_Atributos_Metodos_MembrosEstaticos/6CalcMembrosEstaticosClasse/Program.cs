...
namespace CSharpCursoNelioAlves._2Classes_Atributos_Metodos_MembrosEstaticos._6CalcFuncaoEstaticaDeInstancia
{
        ...
        static void Main(string[] args)
        {
            /*
             =====Membros Estáticos=====
                 ...
                 ->Aplicações comuns: Classes utilitárias e Declaração de (Ex: Math.qrt() )
